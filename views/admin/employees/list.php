      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <?php 
            ...
            $conn = OpenCon();
            $sql = "select e.id,e.full_name,dob,e.email,e.phone_number,d.dept_name,r.role,e.`status` from employees e ,roles r,departments d WHERE e.role_id = r.id
                            ...
                            <td>
                              ...
                              <span>
                                  <?php
                                    if ($row['status']) {
                                      ?>
                                          <a href="delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this employee ?')" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Delete</a>
                                      <?php
                                    }else{
                                        ?>
